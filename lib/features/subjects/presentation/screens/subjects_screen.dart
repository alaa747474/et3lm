...
import '../../business_logic/subject_cubit/subject_cubit.dart';
                ...
                itemBuilder: (BuildContext context, int index) {
                  return InkWell(
                      onTap: () => Navigator.pushNamed(
                          context, LecturesScreen.routeName,
                          arguments: state.subjects[index]),
                      child: SubjectContainer(subject: state.subjects[index]));
                },
              );
            }
            return Container();
